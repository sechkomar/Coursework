...
class Ui_browseWindow(object):
    def setupUi(self, browseWindow):
        ...
        self.filePath = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.filePath.setGeometry(QtCore.QRect(20, 130, 331, 31))
        self.filePath.setObjectName("filePath")

        self.appDescription = QtWidgets.QLabel(self.centralwidget)
        self.appDescription.setGeometry(QtCore.QRect(30, 30, 421, 61))
    ...
    def retranslateUi(self, browseWindow):
        ...
        self.appDescription.setText(_translate("browseWindow",
